...
f=r'C:\Users\USER\OneDrive\Desktop\ImageClassifierML-Lastprototype\Updated\test'#change directory to test folder on your computer 
y=os.listdir(f)
...
if(case==1):
    ...
    if(Modelcase==1):
        ...
        x=os.listdir(r'C:\Users\USER\OneDrive\Desktop\ImageClassifierML-Lastprototype\Updated\Noises1')#change directory to Noises1 folder on your computer 
        output=model.predict(imgs)
    else:
        model=load_model('ClassifierModelB')
        x=os.listdir(r'C:\Users\USER\OneDrive\Desktop\ImageClassifierML-Lastprototype\Updated\Noises2')#change directory to Noises2 folder on your computer 
        output=model.predict(imgs)
